...
if($list_style=="style-1"){
	...
	$events_html.='<div class="ect-event-details">
			    ...
			    <div class="ect-'.esc_attr( $style ).'-more"><a href="'.esc_url( tribe_get_event_link($event_id) ).'" class="ect-events-read-more" rel="bookmark">'.esc_html__( 'Find out more', 'ect' ).' &raquo;</a></div>';
	$events_html.='</div></div>';
        ...
        $events_html.='<div class="ect-'.esc_attr( $style ).'-more"><a href="'.esc_url( tribe_get_event_link($event_id) ).'" class="ect-events-read-more" rel="bookmark">'.esc_html__( 'Find out more', 'ect' ).' &raquo;</a></div>';
	    $events_html.='</div></div>';
