		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">Nov 02,2022 <span class="changelog-version">Lite Version 5.1.14</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Added : Post Content : Get WordPress editor content option in single page','tpebl').'</li>';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">Nov 02,2022 <span class="changelog-version">Pro Version 5.1.3</span></div>';
						echo '<ul class="changelog-list">';	
							echo '<li>'.esc_html__('Update : Display Condition : Product Stock Improved','tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Dynamic Listing : Ajax load Condition Improved','tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Product Listing : Ajax load Condition improved','tpebl').'</li>';
						echo '</ul>';					
				echo '</div>';
