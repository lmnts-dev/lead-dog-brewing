...
if (!class_exists('ectbe_admin_notices')):
    ...
    final class ectbe_admin_notices
    {
        ...
        public function ectbe_add_message($notice)
        {
            ...
            add_action('wp_ajax_ectbe_cool_plugins_admin_notice', array($this, 'ectbe_admin_notice_dismiss'));
            add_action('wp_ajax_cool_plugins_admin_review_notice_dismiss', array($this, 'ectbe_admin_review_notice_dismiss'));
        }
        ...
        private function ectbe_simple_notice($id, $message ){
            ...
            jQuery(document).ready(function ($) {
                ...
                $(document).on("click",".'.$id.'_admin_notice button.notice-dismiss", function (event) {
                    ...
                    $.post(ajaxURL, { "action":"ectbe_cool_plugins_admin_notice","id":id,"_nonce":wp_nonce }, function( data ) {
